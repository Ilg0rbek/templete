...
const dataButton = [
    ...
    {
        id: 5,
        name: 'Mavjud arizani davom ettirish'
    }
]
...
const OfertaPage = ({ nextStep, previousStep }) => {
    ...
    return (
        <>
            ...
            <TabContent className='py-50' activeTab={active}>
                {
                    dataPane.map((pan, index) => (
                        <TabPane key={index} tabId={pan.id}>
                            {pan.render}
                        </TabPane>
                    ))
                }
            ...
            <div className="d-flex justify-content-between">
                <Button color="primary" className="text-center" outline onClick={nextPage}>Orqaga</Button>
                <Button color="primary" className="text-center" onClick={() => nextStep()}>Keyingisi</Button>
            </div>
        </>
    )
}
