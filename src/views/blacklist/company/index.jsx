...
export default () => {
    ...
    const basicColumns = [
        ...
        },
        {
            ...
            cell: () => (
                <div>
                    <Edit onClick={handleModal} color="green" className='me-50' role="button" size={20} />
                </div>
            )
        }
    ]
    ...
    return (
        <>
            <h1 className="mb-2">Ta'qiqlangan tashkilotlar va strategik kamchiliklari mavjud bo`lgan yurisdiksiyalar</h1>
