...
import {getJurnal} from "@store/reducers/Legal_Cancel"
...
export default () => {
    ...
    const basicColumns = [
        ...
        },
        {
            ...
            cell: (row) => (
                <div>
                    <Eye onClick={() => history.push(`/cancel/legal/view/${row?.id}`)} color="green" className='me-50'
                         role="button" size={20}/>
                </div>
            )
        }
        ...
        <Card className='overflow-hidden'>
            ...
            <CardBody>
                <div className='react-dataTable'>
                    <Table data={store?.jurnal} progressPending={store?.isLoading} columns={basicColumns}
                           perPage={store?.perPage} currentPage={store?.currentPage}
