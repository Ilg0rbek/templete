...
import { doNotOpenIndividualBankAccount } from "@store/reducers/Register"
...
const Payment = ({ previousStep }) => {
  ...
  const handleDoNotOpen = () => {
    dispatch(doNotOpenIndividualBankAccount(id)).then(unwrapResult).then(() => history.push(`/applications/individual/view/${id}`))
  }
    ...
    <Fragment>
      ...
      <Form>
            ...
            <div className='border rounded mb-2 p-2'>
              <Row>
                <Col md="6">
                  ...
                  <span>{application?.payment?.invoice}</span>
                </Col>
                <Col md="6">
                  <h5>To‘lov miqdori:</h5>
                  <span>{fCurrency?.format(application?.payment?.amount)} so'm</span>
                </Col>
              </Row>
              <Row className='mt-2'>
                <Col md="6">
                  ...
                  openPaid ? (
                    ...
                    <div>
                      ...
                      <div className='d-flex gap-1 w-25 mx-auto mt-2'>
                        <Button block outline color='danger' onClick={handleDoNotOpen}>YOQ</Button>
        ...
        <div className='d-flex justify-content-between'>
          ...
          {
            openPaid && (
              <Button type='submit' color='success' className='btn-submit' onClick={() => history.push(`/applications/individual/${id}`)}>
                Jo`natish
              </Button>
            )
          }
