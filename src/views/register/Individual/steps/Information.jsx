...
import { invoicePaymentIndividual } from "@store/reducers/Register"
...
const YurInfo = ({ nextStep, previousStep }) => {
  ...
  const handleInvoice = () => {
    dispatch(invoicePaymentIndividual(id)).then(unwrapResult).then(() => nextStep())
  }
  const dataFake = [
    {
  ...
  return (
    <Fragment>
      ...
      <div className='d-flex justify-content-between'>
        ...
        <Button type='submit' color='primary' className='btn-next' onClick={handleInvoice}>
