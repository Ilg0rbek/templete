...
export default () => {
        ...
        },
        {
            ...
            cell: row => (
                <div className='d-flex align-items-center gap-1'>
                    {/* {row.avatar === '' ? ( */}
                    <Avatar color={`light-green`} content={row.name} initials />
                    {/* // ) : ( */}
        ...
        },
        {
            ...
            cell: (row) => (
                <div>
                    ...
                    <List onClick={() => history.push(`${location.pathname}/${row.id}/list`)} color="blue" className='me-50' role="button" size={20} />
                </div>
            )
        }
    ]
    ...
    return (
        <>
            <h1 className="mb-2">Banklar ro'yxati</h1>
            <Card className='overflow-hidden'>
                <CardHeader className='d-flex items-center justify-content-between'>
                    <CardTitle tag='h4'>Bank ma'lumotlar</CardTitle>
