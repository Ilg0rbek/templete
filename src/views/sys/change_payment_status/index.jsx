...
import { ChevronDown, Filter, Eye, Plus } from 'react-feather'
...
export default () => {
    ...
    return (
        <>
            <h1 className="mb-2">To'lov xolatini o'zgartirish</h1>
            <Card className='overflow-hidden'>
                ...
                <CardBody>
                    ...
                    <ModalComponent type={typeModal} open={modalOpen} toggle={() => {
                        toggle()
                        setTypeModal(true)
                    }} />
                </CardBody>
