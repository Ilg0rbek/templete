...
import { ChevronDown, Plus, Filter, Eye, Trash, Edit } from 'react-feather'
...
export default () => {
        ...
        },
        {
            ...
            cell: () => (
                <div>
                    ...
                    {/* <Edit color="blue" onClick={toggle} className='me-50' role="button" size={20} />
    ...
    return (
        <>
            <h1 className="mb-2">Murojaatlar</h1>
