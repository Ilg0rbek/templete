...
export default () => {
        ...
        },
        {
            ...
            cell: () => (
                <div>
                    ...
                    <Edit color="green" onClick={() => history.push(`${location.pathname}/edit?id=5`)} className='me-50' role="button" size={20} />
    ...
    return (
        <>
            <h1 className="mb-2">Arizalar holatini o'zgartirish</h1>
