...
export default [
  ...
  // },
  {
    ...
    children: [
      ...
      {
        id: 'stamp',
        title: 'Muhr va shtamp yasashga buyurtma berish',
        icon: <Circle size={20} />,
        navLink: '/monitoring/stamp'
      }
    ]
    // children: [
    //   {
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: 'Arizalarim',
            navLink: '/certificate/individual/list'
          },
          {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            id: 'certificate-application',
            title: 'Arizalarim',
            navLink: '/certificate/legal/list'
          },
          {
            id: 'certificate-jurnal',
            title: 'Jurnal',
            navLink: '/certificate/legal/jurnal'
          }
        ]
      }
    ]
    ...
    children: [
      {
        ...
        children: [
          {
            title: "Ixtiyoriy tugatish",
            navLink: '/cancel/individual'
          },
          {
            title: "Jurnal",
            navLink: '/cancel/individual_jurnal'
          }
          // {
          //   title: "Bankrotlik"
          //   // navLink: '/cancel/individual'
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: "Bankrotlik",
            navLink: '/cancel/legal_bankrupt'
          },
          {
            title: "Jurnal",
            navLink: '/cancel/legal_jurnal'
          }
        ]
      }
      // {
